...
namespace Bluscream
{
    ...
    public class MoreCommands : BattleBitModule
    {
        ...
        #region commands
        [Commands.CommandCallback("map", Description = "Changes the map", Permissions = new[] { "map" })]
        ...
        [Commands.CommandCallback("gamemode", Description = "Changes the gamemode", Permissions = new[] { "gamemode" })]
        ...
        [Commands.CommandCallback("time", Description = "Changes the map time", Permissions = new[] { "time" })]
        ...
        [Commands.CommandCallback("maprestart", Description = "Restarts the current map", Permissions = new[] { "maprestart" })]
        ...
        [Commands.CommandCallback("allowvotetime", Description = "Changes the allowed map times for votes", Permissions = new[] { "allowvotetime" })]
        ...
        [Commands.CommandCallback("listmaps", Description = "Lists all maps", Permissions = new[] { "*" })]
        public void ListMaps(RunnerPlayer commandSource)
        {
            List<MapInfo> maps = BluscreamLib.Maps.ToList();
        ...
        [Commands.CommandCallback("listmodes", Description = "Lists all gamemodes", Permissions = new[] { "*" })]
        public void ListGameMods(RunnerPlayer commandSource)
        {
            List<GameModeInfo> modes = BluscreamLib.GameModes.ToList();
            ...
            if (!cmdConfig.Enabled) { commandSource.Message($"Command {cmdName} is not enabled on this server!"); return; }
            if (PlayerPermissions is not null && !Extensions.HasAnyRoleOf(commandSource, PlayerPermissions, Extensions.ParseRoles(cmdConfig.AllowedRoles))) { commandSource.Message($"You do not have permissions to run {cmdName} on this server!"); return; }
            commandSource.Message("<b>Available Game Modes:</b>\n\n" + string.Join("\n", modes.Select(m => $"{m.Name}: {m.DisplayName}")));
        }
        [Commands.CommandCallback("listsizes", Description = "Lists all game sizes", Permissions = new[] { "*" })]
        ...
        [Commands.CommandCallback("start", Description = "Force starts the round", Permissions = new[] { "start" })]
        ...
        [Commands.CommandCallback("end", Description = "Force ends the round", Permissions = new[] { "end" })]
        ...
        [Commands.CommandCallback("exec", Description = "Executes a command on the server", Permissions = new[] { "exec" })]
        ...
        [Commands.CommandCallback("bots", Description = "Spawns bots", Permissions = new[] { "bots" })]
        ...
        [Commands.CommandCallback("nobots", Description = "Kicks all bots", Permissions = new[] { "nobots" })]
        ...
        [Commands.CommandCallback("fire", Description = "Toggles bots firing", Permissions = new[] { "fire" })]
        ...
        [Commands.CommandCallback("pos", Description = "Current position (logs to file)", Permissions = new[] { "pos" })]
        public void PosCommand(RunnerPlayer commandSource)
        {
